...
df_indicatori = pd.read_csv("Indicatori.csv", index_col=0)
...
cerinta1.sort_values(by="CFA", ascending=False).to_csv("Cerinta1.csv")
...
df_grouped.to_csv("Cerinta2.csv")
...
linkage_matrix.to_csv("Linkage_Matrix.csv")
